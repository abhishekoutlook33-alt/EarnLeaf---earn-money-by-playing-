...
const LandingHero: React.FC = () => {
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-b from-purple-600 via-indigo-600 to-indigo-900 pt-20 pb-24 lg:pt-32 lg:pb-32">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
         ...
         <div className="absolute top-1/4 left-1/4 w-4 h-4 bg-yellow-300 rounded-full shadow-[0_0_10px_rgba(253,224,71,0.5)] animate-float" style={{animationDelay: '0s'}}></div>
         <div className="absolute top-1/3 right-1/4 w-6 h-6 bg-yellow-300 rounded-full shadow-[0_0_15px_rgba(253,224,71,0.5)] animate-float" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6">
            ...
            <p className="text-lg text-purple-100 font-medium max-w-2xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="pt-4 flex justify-center lg:justify-start">
              <button className="bg-white text-purple-700 hover:bg-purple-50 font-bold py-3.5 px-8 rounded-full shadow-lg transition-all transform hover:scale-105 active:scale-95 flex items-center gap-2">
                Get Started
                ...
                <div className="space-y-4">
                   <div className="relative">
                      ...
                      <input 
                        ...
                        className="w-full bg-indigo-950/40 border border-purple-300/30 rounded-lg py-3 pl-10 pr-4 text-white placeholder-purple-200 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all"
                      />
                   </div>
                   
                   <button className="w-full bg-emerald-400 hover:bg-emerald-500 text-emerald-950 font-bold py-3 rounded-lg shadow-lg shadow-emerald-900/20 transition-all transform hover:-translate-y-0.5">
                     Start Earning Now
                   </button>
                   ...
                   <div className="space-y-3">
                      <button className="w-full bg-white text-gray-700 font-semibold py-2.5 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2">
                         <svg className="w-5 h-5" viewBox="0 0 24 24"><path fill="currentColor" d="M12.545,10.239v3.821h5.445c-0.712,2.315-2.647,3.972-5.445,3.972c-3.332,0-6.033-2.701-6.033-6.032s2.701-6.032,6.033-6.032c1.498,0,2.866,0.549,3.921,1.453l2.814-2.814C17.503,2.988,15.139,2,12.545,2C7.021,2,2.543,6.477,2.543,12s4.478,10,10.002,10c8.396,0,10.249-7.85,9.426-11.748L12.545,10.239z"/></svg>
                         Sign up via Google
                      </button>
                      <button className="w-full bg-[#1877F2] text-white font-semibold py-2.5 rounded-lg hover:bg-[#166fe5] transition-colors flex items-center justify-center gap-2">
                      ...
                      <button className="w-full bg-[#171a21] text-white font-semibold py-2.5 rounded-lg hover:bg-[#2a2e38] transition-colors flex items-center justify-center gap-2">
